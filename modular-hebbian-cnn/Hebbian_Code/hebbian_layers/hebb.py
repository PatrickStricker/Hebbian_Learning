...
class HebbianConv2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, dilation=1, padding=0,
                 ...
                 sigma_i=1.4,
                 lateral_kernel=5,
                 lr=0.1, hpca_rule="full", use_wta_for_hpca=False):
        """
        ...
        self.hpca_rule = hpca_rule          # "full" or "sanger"
        self.use_wta_for_hpca = use_wta_for_hpca
    ...
    def compute_update(self, x, y, weight):
        if self.mode == self.MODE_HPCA:
            update = self.update_hpca(x, y, weight)
        elif self.mode == self.MODE_BASIC_HEBBIAN:
    ...
    def update_hpca(self, x, y, weight):
        ...
        # Competitive Oja / neural PCA term
