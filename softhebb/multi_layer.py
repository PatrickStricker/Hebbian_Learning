...
parser.add_argument('--author-preprocessing', default=False, type=str2bool, metavar='N',
                    help='Use RMS normalization, feature whitening, and unit L2 scaling')
...
if __name__ == '__main__':
    ...
    dataset_sup_config['author_preprocessing'] = params.author_preprocessing
    dataset_unsup_config['author_preprocessing'] = params.author_preprocessing

    if params.author_preprocessing:
        dataset_sup_config['zca_whitened'] = False
        dataset_unsup_config['zca_whitened'] = False
