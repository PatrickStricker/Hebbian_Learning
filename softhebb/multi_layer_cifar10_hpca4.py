...
parser = argparse.ArgumentParser(description="Ray-free CIFAR10 HPCA4 run")

parser.add_argument("--preset", default="4HPCACnnCIFAR", type=str)
...
parser.add_argument("--model-name", default="CIFAR10_HPCA4_seed0", type=str)
